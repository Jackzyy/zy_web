    ...
    <div class="form">
      <el-form :model="pushArtForm" label-position="top" label-width="80px">
        ...
        <el-form-item :required="true" label="正文内容 ：">
          <div class="ue">
            <VueUeditorWrap v-model="pushArtForm.content" :defaultMsg="defaultMsg" :config="config"></VueUeditorWrap>
          </div>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      pushArt(){//发布文章
        ...
        pushArtForm.append('aid',this.pushArtForm.aid)
